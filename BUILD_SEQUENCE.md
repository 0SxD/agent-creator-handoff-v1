...
- **Output:** `README.md`
- **Validation:** under 250 lines, no Track B references, citations point to verifiable URLs
- **Parallelizable:** no
...
- **Prereq:** Phase 1 done
- **Source:** WORKSTREAM_protocol_governance.md + research findings section 9 (multi-turn awareness) + the renamed protocol content (derived from /mnt/project/143_protocol_a_blueprint.md but with all blocklisted terms replaced)
...
- **Sub-agent:** claude_sonnet_4_6, effort medium
- **Action:** Write `skills/trinity_rubric/SKILL.md`. 9-cell Trinity grid (Pathos/Ethos/Logos x Coverage/Self-contained/Importance). Modes: boolean, sparse-jump-3, scaled-0-1. ML backend hook (none | gepa | openevolve | custom).
...
## Phase 7: Architect approval gate (PEL)

### Step 7.1 Fill PEL_GATE_TEMPLATE.md
- **Prereq:** Phase 6 done
- **Action:** Fill the Pathos / Ethos / Logos sections per PEL_GATE_TEMPLATE.md.
- **Output:** filled PEL gate document, posted to Architect
